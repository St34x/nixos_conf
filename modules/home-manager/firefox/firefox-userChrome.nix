...
with colors; ''
  ...
  ::selection {
    background: ${tab-selected-bg} !important;
  }
  ...
  #PlacesToolbar menupopup[placespopup="true"] {
    ...
    --arrowpanel-color: ${icon-color} !important;
  }
  ...
  #urlbar-results {
    ...
    color: ${urlbar-results-color} !important;
  }
  ...
  .search-panel-one-offs-container {
    color: ${urlbar-results-url-color} !important;
  ...
  #urlbar-input:focus {
    color: ${urlbar-focused-color} !important;
  }
  ...
  #PlacesToolbar menuitem:hover {
    background-color: ${tab-selected-bg} !important;
  }
  ...
  menupopup {
    ...
    --panel-color: ${icon-color} !important;
  }
